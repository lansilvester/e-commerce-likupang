                ...
                <div class="card flex-fill">
                            ...
                            <div class="col-md-4">
                                <form action="{{ route('search_destinasi_wisata') }}" method="GET">
                                    <div class="input-group mb-3">
                                        <input type="text" name="search" style="margin-right:10px" class="form-control" placeholder="Cari Nama Destinasi Wisata" value="{{ request('search') }}">
                    ...
                    <div class="card-body">
                        <table class="table table-hover table-responsive">
                            ...
                            <tbody>
                                @forelse ($data_destinasi_wisata as $i => $data)
                                <tr>
                                    <td>{{ $i + 1 }}</td>
