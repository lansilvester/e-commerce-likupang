...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3"><strong>Data Homestay</strong></h1>
                            ...
                            <div class="col-md-4">
                                <form action="{{ route('search_homestay') }}" method="GET">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" name="search" style="margin-right:20px" class="form-control" placeholder="Cari Nama Homestay" value="{{ request('search') }}">
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="submit"><i data-feather="search"></i></button>
                                        </div>
                                        @if(request('search'))
                                        <div class="input-group-append" style="margin-left:10px">
                                            <a href="{{ route('dashboard_homestay.index') }}" class="btn btn-danger"><i data-feather="x"></i></a>
                        ...
                        <table class="table table-hover table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('storage/homestay/' . $data->foto) }}" alt="Gambar Destinasi Wisata" width="150px">
                                    </td>
                                    <td>
