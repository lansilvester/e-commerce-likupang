...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3"><strong>Souvenir</strong></h1>
                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-header">
                        <div class="row d-flex justify-content-between">
                            <div class="col-md-4">
                                <form action="{{ route('search_souvenir') }}" method="GET">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" name="search" style="margin-right:20px" class="form-control" placeholder="Cari Nama Souvenir" value="{{ request('search') }}">
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="submit"><i data-feather="search"></i></button>
                                        </div>
                                        @if(request('search'))
                                        <div class="input-group-append" style="margin-left:10px">
                                            <a href="{{ route('dashboard_souvenir.index') }}" class="btn btn-danger"><i data-feather="x"></i></a>
                            ...
                            <div class="col-md-2">
                                <a href="{{ route('dashboard_souvenir.create') }}" class="btn btn-success"><i data-feather="plus"></i> Tambah Data</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
